  ...
  return (
    <View style={styles.container}>
      <ScrollView
        ...
        <Text style={styles.badge}>HQ ADMIN</Text>
        <Text style={styles.title}>매장 본사 어드민</Text>
        ...
        <View style={styles.cardGrid}>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.statValue}>본사</Text>
            <Text style={styles.statMeta}>매장 본사 접속</Text>
          </View>
          <View style={styles.statCard}>
