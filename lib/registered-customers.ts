...
import { ACCUMULATED_TEST_CUSTOMERS, ACCUMULATED_TEST_CUSTOMERS_1Y } from './demo-accumulated-test-accounts';
...
async function fetchDemoRegisteredCustomers(
  ...
  for (const account of [...BETA_CUSTOMERS, ...ACCUMULATED_TEST_CUSTOMERS, ...ACCUMULATED_TEST_CUSTOMERS_1Y]) {
